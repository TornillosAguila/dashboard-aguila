...
(function () {
  ...
  function buildMesSection() {
    ...
    // Apilada general con altura fija controlada
    cont.innerHTML = `
      <div class="charts-row cols-1" style="margin-bottom:16px">
        <div class="panel">
          ...
          <div style="position:relative;width:100%;height:220px">
            <canvas id="chartApilado" role="img" aria-label="Barras apiladas de canales por corte"></canvas>
          </div>
        </div>
      </div>`;

    // Mini-gráficas: siempre 3 columnas, altura fija 160px
    ...
    V.meses.forEach((mes, i) => {
      ...
      rows += '<div class="panel panel-mes">'
        ...
        + '<canvas id="chartMes_' + mes + '" data-mes="' + mes + '" data-color="' + col + '" role="img" aria-label="Ventas ' + lbl + '"></canvas>'
        + '</div></div>';
    });
    rows += '</div>';
    cont.innerHTML += rows;
